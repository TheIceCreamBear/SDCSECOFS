...
compile :
	gcc -pthread ./src/ourprogram.c ./src/concurrencylib.c ./src/userprogram.c -o ./bin/linux-threads-x86-64.exe
else ifeq ($(shell uname -s),Darwin)
run : compile
	./bin/macos-threads-x86-64.exe
compile :
	gcc -pthread ./src/ourprogram.c ./src/concurrencylib.c ./src/userprogram.c -o ./bin/macos-threads-x86-64.exe
else
run :
